...
import { ɵangular_packages_forms_forms_j } from '@angular/forms';
import { stat } from 'fs';
import { type } from 'os';
...
export class CommonLookupServiceProxy {
    ...
    getLookup(source:string | undefined, lookup_type:string | undefined): Observable<PagedResultDtoOfNameValueDto> {
        let url_ = this.baseUrl + "/api/services/app/CommonLookup/GetLookup";
        if (source === null)
...
@Injectable()
export class CustomLookupServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getLookup(source:string | undefined, lookup_type:string | undefined): Observable<PagedResultDtoOfNameValueDto> {
        let url_ = this.baseUrl + "/api/services/app/CustomLookup/GetLookup?";
        if (source === null)
            throw new Error("The parameter 'source' cannot be null.");
        else if (source !== undefined)
            url_ += "source=" + encodeURIComponent("" + source) + "&"; 
...
export class ItemServiceProxy {
     ...
     * @return Success
     */
    getItem(filter: string | undefined): Observable<ListResultDtoOfItemListDto> {
        let url_ = this.baseUrl + "/api/services/app/Item/GetItem?";
        if (filter === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfItemListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfItemListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetItem(response: HttpResponseBase): Observable<ListResultDtoOfItemListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ListResultDtoOfItemListDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfItemListDto>(<any>null);
    }

    /**
     * @return Success
     */
    getUserAccount(): Observable<ListResultDtoOfUserAccountDto> {
        let url_ = this.baseUrl + "/api/services/app/Item/GetUserAccount";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfUserAccountDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfUserAccountDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetUserAccount(response: HttpResponseBase): Observable<ListResultDtoOfUserAccountDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ListResultDtoOfUserAccountDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfUserAccountDto>(<any>null);
    }
     ...
     * @return Success
     */
    createItem(body: CreateItemInput | undefined): Observable<void> {
     ...
     * @return Success
     */
    generateReport(filter: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Item/GenerateReport?";
        if (filter === null)
            throw new Error("The parameter 'filter' cannot be null.");
        else if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
...
export class ReportServiceProxy {
     ...
     * @return Success
     */
    getReportLink(filter: string | undefined): Observable<ListResultDtoOfReportListDto> {
        let url_ = this.baseUrl + "/api/services/app/Report/GetReportLink?";
        if (filter === null)
            throw new Error("The parameter 'filter' cannot be null.");
        else if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetReportLink(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetReportLink(<any>response_);
                } catch (e) {
                    return <Observable<ListResultDtoOfReportListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfReportListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetReportLink(response: HttpResponseBase): Observable<ListResultDtoOfReportListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ListResultDtoOfReportListDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfReportListDto>(<any>null);
    }
}
...
export class TenantDashboardServiceProxy {
     ...
     * @return Success
     */
    getOutOfStock(): Observable<GetOutOfStockOutput> {
        let url_ = this.baseUrl + "/api/services/app/TenantDashboard/GetOutOfStock";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetOutOfStock(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetOutOfStock(<any>response_);
                } catch (e) {
                    return <Observable<GetOutOfStockOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetOutOfStockOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetOutOfStock(response: HttpResponseBase): Observable<GetOutOfStockOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetOutOfStockOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetOutOfStockOutput>(<any>null);
    }

    /**
     * @return Success
     */
    getPOSummary(): Observable<GetPoSummaryOutput> {
        let url_ = this.baseUrl + "/api/services/app/TenantDashboard/GetPoSummary";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPOSummary(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPOSummary(<any>response_);
                } catch (e) {
                    return <Observable<GetPoSummaryOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetPoSummaryOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetPOSummary(response: HttpResponseBase): Observable<GetPoSummaryOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetPoSummaryOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetPoSummaryOutput>(<any>null);
    }
}
...
export class ListResultDtoOfItemListDto implements IListResultDtoOfItemListDto {
    items!: ItemListDto[] | undefined;

    constructor(data?: IListResultDtoOfItemListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["items"])) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(ItemListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfItemListDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfItemListDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfItemListDto {
    items: ItemListDto[] | undefined;
}
...
export class ListResultDtoOfUserAccountDto implements IListResultDtoOfUserAccountDto {
    items!: UserAccountDto[] | undefined;

    constructor(data?: IListResultDtoOfUserAccountDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["items"])) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(UserAccountDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfUserAccountDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfUserAccountDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfUserAccountDto {
    items: UserAccountDto[] | undefined;
}
...
export class CreateItemInput implements ICreateItemInput {
    ...
    constructor(data?: ICreateItemInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateItemInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateItemInput();
        result.init(data);
        return result;
    }
...
export class ListResultDtoOfReportListDto implements IListResultDtoOfReportListDto {
    items!: ReportListDto[] | undefined;

    constructor(data?: IListResultDtoOfReportListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (Array.isArray(data["items"])) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items!.push(ReportListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfReportListDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfReportListDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfReportListDto {
    items: ReportListDto[] | undefined;
}
...
export class GetOutOfStockOutput implements IGetOutOfStockOutput {
    stats!: OutOfStockItem[] | undefined;

    constructor(data?: IGetOutOfStockOutput) {
        if(data) {
            for (var property in data) {
                if(data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?:any) {
        if(data) {
            if(Array.isArray(data["stats"])) {
                this.stats = [] as any;
                for (let item of data["stats"])
                    this.stats!.push(OutOfStockItem.fromJS(item));
            }
        }
    }

    static fromJS(data: any): GetOutOfStockOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetOutOfStockOutput();
        result.init(data);
        return result;
    }
...
export interface IGetOutOfStockOutput {
    stats: OutOfStockItem[] | undefined;
}
export class OutOfStockItem implements IOutofStockItems {
    ...
    constructor(data?: IOutofStockItems) {
        if(data) {
            for (var property in data) {
                if(data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if(data) {
            ...
            this.lstMvDt = data["lstMvDt"];
            this.qty = data["qty"];
            this.status = data["status"];
        }
    }

    static fromJS(data:any): OutOfStockItem {
        data = typeof data === 'object' ? data : {};
        let result = new OutOfStockItem();
        result.init(data);
        return result;
    }
...
export interface IOutofStockItems {
    sku: string | undefined;
...
export class GetPoSummaryOutput implements IGetPoSummaryOutput {
    poSummary!: PoSummaryData[] | undefined;

    constructor(data?: IGetPoSummaryOutput) {
        if(data) {
            for (var property in data) {
                if(data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?:any) {
        if(data) {
            if(Array.isArray(data["poSummary"])) {
                this.poSummary = [] as any;
                for (let item of data["poSummary"])
                    this.poSummary!.push(PoSummaryData.fromJS(item));
            }
        }
    }

    static fromJS(data: any): GetPoSummaryOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetPoSummaryOutput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (Array.isArray(this.poSummary)) {
            data["poSummary"] = [];
            for (let item of this.poSummary)
                data["poSummary"].push(item.toJSON());
        }
        return data; 
    }
...
export interface IGetPoSummaryOutput {
    poSummary: PoSummaryData[] | undefined;
}

export class PoSummaryData implements IPoSummaryData {
    totalOpenPO!: number;
    percentTotalOpenPO!: number;
    totalOpenLine!: number;
    percentTotalOpenLine!: number;
    totalOpenQty!: number;
    percentTotalOpenQty!: number;

    constructor(data?: IPoSummaryData) {
        if(data) {
            for(var property in data) {
                if(data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if(data) {
            this.totalOpenPO = data["totalOpenPO"];
            this.percentTotalOpenPO = data["percentTotalOpenPO"];
            this.totalOpenLine = data["totalOpenLine"];
            this.percentTotalOpenLine = data["percentTotalOpenLine"];
            this.totalOpenQty = data["totalOpenQty"];
            this.percentTotalOpenQty = data["percentTotalOpenQty"];
        }
    }

    static fromJS(data:any): PoSummaryData {
        data = typeof data === 'object' ? data : {};
        let result = new PoSummaryData();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["totalOpenPO"] = this.totalOpenPO;
        data["percentTotalOpenPO"] = this.percentTotalOpenPO;
        data["totalOpenLine"] = this.totalOpenLine;
        data["percentTotalOpenLine"] = this.percentTotalOpenLine;
        data["totalOpenQty"] = this.totalOpenQty;
        data["percentTotalOpenQty"] = this.percentTotalOpenQty;
        return data;
    }
}

export interface IPoSummaryData {
    totalOpenPO: number;
    percentTotalOpenPO: number;
    totalOpenLine: number;
    percentTotalOpenLine: number;
