...
export class CreateOrEditUserModalComponent extends AppComponentBase {
    ...
    @ViewChild('organizationUnitList', {static: false}) organizationUnitList: OrganizationUnitsListComponent;
    ...
    onShown(): void {
        ...
        */
        ...
        this.organizationUnitList.data = <IOrganizationUnitsTreeComponentData>{
            allOrganizationUnits: this.allOrganizationUnits,
            selectedOrganizationUnits: this.memberedOrganizationUnits
        };
    ...
    save(): void {
        ...
        input.organizationUnits = this.organizationUnitList.getSelectedOrganizations();
