...
import { WidgetOutOfStockComponent} from './widgets/widget-out-of-stock/widget-out-of-stock.component';
import { WidgetPOSummary} from './widgets/widget-po-summary/widget-po-summary.component';
...
export class DashboardViewConfigurationService {
  ...
  private initializeConfiguration() {
    ...
    let OutOfStock = new WidgetViewDefinition(
      DashboardCustomizationConst.widgets.tenant.outOfStock,
      WidgetOutOfStockComponent,
    )

    let poSummary = new WidgetViewDefinition(
      DashboardCustomizationConst.widgets.tenant.poSummary,
      WidgetPOSummary,
    )
   ...
   //add your host side widgets here
    ...
    this.WidgetViewDefinitions.push(OutOfStock);
    this.WidgetViewDefinitions.push(poSummary);
