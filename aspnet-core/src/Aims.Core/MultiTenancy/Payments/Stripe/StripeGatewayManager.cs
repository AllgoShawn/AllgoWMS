...
namespace Aims.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : AimsServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Aims";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + AimsConsts.Currency;
        }
