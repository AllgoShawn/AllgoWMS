...
namespace Aims.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : AimsServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Aims", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
