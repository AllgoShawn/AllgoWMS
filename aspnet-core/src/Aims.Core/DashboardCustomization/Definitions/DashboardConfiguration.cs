...
namespace Aims.DashboardCustomization.Definitions
{
    public class DashboardConfiguration
    {
        ...
        public DashboardConfiguration()
        {
            ...
            var outOfStock = new WidgetDefinition(
                AimsDashboardCustomizationConsts.Widgets.Tenant.OutOfStock,
                "WidgetOutOfStock",
                side: MultiTenancySides.Tenant,
                permissions: tenantWidgetsDefaultPermission);

            var poSummary = new WidgetDefinition(
            ...
            WidgetDefinitions.Add(outOfStock);
            WidgetDefinitions.Add(poSummary);
            ...
            var defaultTenantDashboard = new DashboardDefinition(
                AimsDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                new List<string>
                {
                    //generalStats.Id, dailySales.Id, profitShare.Id, memberActivity.Id, regionalStats.Id, topStats.Id, salesSummary.Id, poSummary.Id, outOfStock.Id
                    poSummary.Id, outOfStock.Id
                });

            DashboardDefinitions.Add(defaultTenantDashboard);

            var defaultHostDashboard = new DashboardDefinition(
                AimsDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                new List<string>
                {
                    incomeStatistics.Id,
                    hostTopStats.Id,
