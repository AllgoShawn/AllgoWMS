...
using Aims.Core.Base;
using Aims.Core.Extensions;
using Aims.Dto;
using Aims.Types;

namespace Aims.Queries
{
    public class OrganizationUnitQuery : AimsQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
