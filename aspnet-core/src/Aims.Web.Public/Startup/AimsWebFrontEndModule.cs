...
namespace Aims.Web.Public.Startup
{
    [DependsOn(
        typeof(AimsWebCoreModule)
    )]
    public class AimsWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public AimsWebFrontEndModule(IWebHostEnvironment env, AimsEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AimsWebFrontEndModule).GetAssembly());
        }
    }
}
