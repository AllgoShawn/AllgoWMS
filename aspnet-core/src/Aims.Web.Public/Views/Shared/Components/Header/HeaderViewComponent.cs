...
using Aims.Url;
using Aims.Web.Public.Startup;
using Aims.Web.Session;

namespace Aims.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : AimsViewComponent
    {
