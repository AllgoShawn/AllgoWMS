namespace Aims
{
    public class AimsDashboardCustomizationConsts
    {
        /// <summary>
        ...
        public class Widgets
        {
            public class Tenant
            {
                ...
                public const string OutOfStock = "Widgets_Tenant_OutOfStock";
                public const string poSummary = "Widgets_Tenant_POSummary";
            }
