...
using Aims.EntityFrameworkCore.Repositories;

namespace Aims.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : AimsRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<AimsDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
