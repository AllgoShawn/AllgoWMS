...
{
    public class SubscriptionPaymentRepository : AimsRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<AimsDbContext> dbContextProvider)
