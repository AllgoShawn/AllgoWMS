...
using Aims.Hangfire;
using Aims.Web.Common;
using Abp.Hangfire.Configuration;

namespace Aims.Web.Startup
{
    [DependsOn(
        typeof(AimsWebCoreModule)
    )]
    public class AimsWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AimsWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AimsWebHostModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            if (IocManager.Resolve<IMultiTenancyConfig>().IsEnabled)
            {
                ...
                workManager.Add(IocManager.Resolve<StatusDataSyncService>());
                workManager.Add(IocManager.Resolve<OrderInTransitDataSyncService>());
                workManager.Add(IocManager.Resolve<OrderClosedDataSyncService>());
            }
