...
namespace Aims.Tenants.Dashboard
{
    ...
    public class TenantDashboardAppService : AimsAppServiceBase, ITenantDashboardAppService
    {
        ...
        public GetPoSummaryOutput GetPoSummary()
        {
            
            DashboardPoSummaryGenerator poSummary = new DashboardPoSummaryGenerator(_env);
            return new GetPoSummaryOutput(
                poSummary.GeneratePOSummary()
            );
        }

        public GetOutOfStockOutput GetOutOfStock()
        {
            DashboardOutOfStockGenerator outOfStock = new DashboardOutOfStockGenerator(_env);
            return new GetOutOfStockOutput(
                outOfStock.GenerateOutOfStock()
            );
        }
