...
using Aims.Migrations.Seed.Host;
...
namespace Aims.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : AimsAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<AimsDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(AimsConsts.ConnectionStringName).Value.ToString();
        }
