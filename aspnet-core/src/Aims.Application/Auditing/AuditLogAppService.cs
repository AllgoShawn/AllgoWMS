...
using Aims.Auditing.Exporting;
using Aims.Authorization;
using Aims.Authorization.Users;
using Aims.Dto;
using Aims.EntityHistory;
using EntityHistoryHelper = Aims.EntityHistory.EntityHistoryHelper;

namespace Aims.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : AimsAppServiceBase, IAuditLogAppService
    {
