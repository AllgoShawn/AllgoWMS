...
using Aims.DashboardCustomization.Definitions;
using Aims.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Aims.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : AimsAppServiceBase, IDashboardCustomizationAppService
    {
