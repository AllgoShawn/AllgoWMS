...
using MvvmHelpers;
using Aims.Authorization.Users.Profile;
using Aims.Authorization.Users.Profile.Dto;
using Aims.Commands;
using Aims.Core.Threading;
using Aims.Models.NavigationMenu;
using Aims.Services.Navigation;
...
using Aims.ApiClient;
using Aims.Controls;
using Aims.Dto;
using Aims.Extensions;
using Aims.Localization;
using Aims.UI;
using Aims.UI.Assets;
using Aims.Views;
using DependencyResolver = Aims.Core.Dependency.DependencyResolver;
...
namespace Aims.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Aims";
