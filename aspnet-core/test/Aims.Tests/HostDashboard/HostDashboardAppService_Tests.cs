...
using Aims.MultiTenancy.HostDashboard;
...
namespace Aims.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(AimsDbContext context, SubscriptionPayment subscriptionPayment)
        {
